...
namespace Server.Engines.Craft
{
	...
	public class DefBeverage : CraftSystem
	{
		...
		{
			return 75.0; // Everyone gets a chance
		}
		...
		public override void InitCraftList()
		{
			...
			index = AddCraft(typeof(CoffeeMug), 1155736, 1155737, 0.0, 25, typeof(CoffeeGrounds), 1155735, 1, "You are missing Coffee Grounds");
			AddRes(index, typeof(BaseBeverage), 1046458, 1, "You need more water");
			SetBeverageType(index, BeverageType.Water);
			ForceNonExceptional(index);

			index = AddCraft(typeof(GreenTeaMug), 1155736, 1030315, 0.0, 25, typeof(GreenTeaBasket), 1155735, 1, 1044253);
			AddRes(index, typeof(BaseBeverage), 1046458, 1, 1044253);
			SetBeverageType(index, BeverageType.Water);
			ForceNonExceptional(index);

			index = AddCraft(typeof(HotCocoaMug), 1155736, 1155738, 0.0, 25, typeof(CocoaLiquor), 1080007, 1, 1080006);

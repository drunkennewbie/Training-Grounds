...
namespace Server.Items
{
	...
	public class TribalBedroll : Item
	{
		[Constructable]
		public TribalBedroll() : base(0xA57)
		{
			Name = "Tribal Bed Roll";
			Hue = 0x03f0;
			Weight = 5.0;
		}

		public TribalBedroll(Serial serial) : base(serial)
		{
		}
		...
		private class LogoutGump : Gump
		{
			...
			private TribalBedroll m_Bedroll;

			public LogoutGump(CampfireEntry entry, TribalBedroll bedroll) : base(100, 0)
			{
				m_Entry = entry;
				m_Bedroll = bedroll;

...
{
	public class NewQuestGump : BaseQuestGump
	{
		...
		public NewQuestGump(PlayerMobile from)
			: this(from, null, Section.Main, false, false)
		{
		}

		public NewQuestGump(BaseQuest quest)
			: this(quest, Section.Description, true)
		{
		}

		public NewQuestGump(BaseQuest quest, Section section, bool offer)
			: this(null, quest, section, offer, false)
		{
		}

		public NewQuestGump(BaseQuest quest, Section section, bool offer, bool completed)
			: this(null, quest, section, offer, completed)
		{
		}

		public NewQuestGump(PlayerMobile owner, BaseQuest quest, Section section, bool offer, bool completed)
			: this(owner, quest, section, offer, completed, null)
		{
		}

		public NewQuestGump(PlayerMobile owner, BaseQuest quest, Section section, bool offer, bool completed, object quester)
			: base(75, 25)
		{
			m_Quester = quester;
			m_Quest = quest;

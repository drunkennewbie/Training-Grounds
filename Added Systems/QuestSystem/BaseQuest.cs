...
namespace Server.Engines.Quests
{
	public class BaseQuest
	{
		...
		public List<BaseObjective> Objectives { get { return m_Objectives; }}
		public List<BaseReward> Rewards	{ get { return m_Rewards; }}
		...
		public Type QuesterType { get {	return m_QuesterType; } set	{ m_QuesterType = value; }}

		public BaseQuestItem StartingItem {	get	{ return m_Quester is BaseQuestItem ? (BaseQuestItem)m_Quester : null;	}}

		public NewQuester StartingMobile { get { return m_Quester is NewQuester ? (NewQuester)m_Quester : null;	}}
		...
		public virtual void GiveRewards()
		{
			...
			if (NextQuest != null)
			{
				...
				if (quest != null && quest.ChainID == ChainID)
					m_Owner.SendGump(new NewQuestGump(quest));
			}

...
{
	public abstract class NewQuester : BaseVendor
	{
		protected readonly List<SBInfo> m_SBInfos = new List<SBInfo>();
		private DateTime m_Spoken;
		public NewQuester(): base(null) { SpeechHue = 0x3B2;}
		public NewQuester(string name): this(name, null){}

		public NewQuester(string name, string title): base(title)
		{
			Name = name;
			SpeechHue = 0x3B2;
		}

		public NewQuester(Serial serial): base(serial) {		}

		public override void CheckMorph() { } // Don't morph me!

...
{
	public class TestsWand : MagicWand
	{
		...
		[Constructable]
		public TestsWand() : this( 100 )
		{
		}

		[Constructable]
		public TestsWand( int charges )
		{
			m_Charges = charges;
			LootType = LootType.Blessed;
		}

		public TestsWand( Serial serial ) : base( serial )
		{
		}
	...
	public class TestGump : Gump
	{
			...
			: base(0, 0)
		{
			...
			this.AddPage(0);
			this.AddBackground(129, 122, 407, 396, 9200);
			this.AddImage(78, 59, 10400);
			this.AddImage(78, 221, 10401);
			this.AddImage(79, 456, 10402);
			this.AddImage(505, 65, 10410);
			this.AddImage(504, 222, 10411);
			this.AddImage(504, 439, 10412);
			this.AddImage(138, 131, 5593);

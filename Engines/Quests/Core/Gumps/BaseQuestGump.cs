...
namespace Server.Engines.Quests.Gumps
{
	...
	public abstract class BaseQuestGump : Gump
	{
		...
		public void AddDescription(Quests quest)
		{
		...
		public void AddObjectives(Quests quest)
		{
		...
		public void AddObjectivesProgress(QuestInstance instance)
		{
		...
		public void AddRewardsPage(Quests quest) // For the quest log/offer gumps
		{
		...
		public void AddRewards(Quests quest) // For the claim rewards gump
		{
			int y = 146;
		...
		public void AddRewards(Quests quest, int x, int y, int spacing)
		{
			int xReward = x + 28;

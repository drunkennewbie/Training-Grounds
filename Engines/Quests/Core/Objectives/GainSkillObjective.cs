...
namespace Server.Engines.Quests.Objectives
{
	...
	public class GainSkillObjective : BaseObjective
	{
		...
		public override bool CanOffer(IQuestGivers quester, PlayerMobile pm, bool message)
		{
			...
			{
				if (message)
					QuestSystem.Tell(quester, pm, 1077772); // I cannot teach you, for you know all I can teach!
	...
	public class GainSkillObjectiveInstance : BaseObjectiveInstance
	{
		...
		public GainSkillObjectiveInstance(GainSkillObjective objective, QuestInstance instance)

...
namespace Server.Engines.Quests.Objectives
{
	public class DeliverObjective : BaseObjective
	{
		...
		public DeliverObjective(Type delivery, int amount, TextDefinition name, Type destination, bool spawnsDelivery)
		{
			...
			if (QuestSystem.Debug && name.Number > 0)
			{
	...
	public class DeliverObjectiveInstance : BaseObjectiveInstance
	{
		...
		public DeliverObjectiveInstance(DeliverObjective objective, QuestInstance instance)
			: base(instance, objective)
		{
			m_Objective = objective;
		}

		public virtual bool IsDestination(IQuestGivers quester, Type type)
		{

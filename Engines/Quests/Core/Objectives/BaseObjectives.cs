...
namespace Server.Engines.Quests.Objectives
{
	public abstract class BaseObjective
	{
		...
		public virtual bool CanOffer(IQuestGivers quester, PlayerMobile pm, bool message)
		{
			return true;
		}
		...
		public virtual BaseObjectiveInstance CreateInstance(QuestInstance instance)
		{
			return null;
		}
	}
	...
	public abstract class BaseObjectiveInstance
	{
		...
		public BaseObjectiveInstance(QuestInstance instance, BaseObjective obj)
		{
			m_Instance = instance;

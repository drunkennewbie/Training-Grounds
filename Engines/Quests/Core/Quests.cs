...
namespace Server.Engines.Quests
{
	...
	public interface IQuestGivers
	{
		List<Quests> Quests { get; }
	...
	public class Quests
	{
		...
		private List<QuestInstance> m_Instances;
		...
		public bool Activated //Quest Turned on?
		{
		...
		public List<QuestInstance> Instances
		{
		...
		public Quests()
		{
			...
			m_Instances = new List<QuestInstance>();
		...
		{
			string name = String.Format("QS-{0}", GetType().Name);
		...
		public QuestInstance CreateInstance(IQuestGivers quester, PlayerMobile pm)
		{
			return new QuestInstance(this, quester, pm);
		}

		public bool CanOffer(IQuestGivers quester, PlayerMobile pm, bool message)
		{
			return CanOffer(quester, pm, QuestSystem.GetContext(pm), message);
		}

		public virtual bool CanOffer(IQuestGivers quester, PlayerMobile pm, QuestContext context, bool message)
		{
			...
			if (context != null)
			{
				...
				{
					if (message)
						QuestSystem.Tell(quester, pm, 1080107); // I'm sorry, I have nothing for you at this time.

					return false;
				}

				Quests checkQuest = this;
				...
				while (checkQuest != null)
				{
					...
					if (context.HasDoneQuest(checkQuest, out nextAvailable))
					{
						...
						{
							if (message)
								QuestSystem.Tell(quester, pm, 1075454); // I cannot offer you the quest again.
						...
						{
							if (message)
								QuestSystem.Tell(quester, pm, 1075575); // I'm sorry, but I don't have anything else for you right now. Could you check back with me in a few minutes?
					...
					checkQuest = QuestSystem.FindQuest(checkQuest.NextQuest);
				}
			}
		...
		public virtual void SendOffer(IQuestGivers quester, PlayerMobile pm)
		{
			pm.SendGump(new NQuestOfferGump(this, quester, pm));
		}

		public virtual void OnAccept(IQuestGivers quester, PlayerMobile pm)
		{
			if (!CanOffer(quester, pm, true))
				return;

			QuestInstance instance = CreateInstance(quester, pm);
		...
		public virtual void OnAccepted(QuestInstance instance)
		{
		}

		public virtual void OnRefuse(IQuestGivers quester, PlayerMobile pm)
		{
			pm.SendGump(new QuestConversationGump(this, pm, RefusalMessage));
		}

		public virtual void GetRewards(QuestInstance instance)
		{
			instance.SendRewardGump();
		}

		public virtual void OnRewardClaimed(QuestInstance instance)
		{
		}

		public virtual void OnCancel(QuestInstance instance)
		{
		}

		public virtual void OnQuesterDeleted(QuestInstance instance)
		{
		}

		public virtual void OnPlayerDeath(QuestInstance instance)
		{
		}
		...
		public static void Serialize(GenericWriter writer, Quests quest)
		{

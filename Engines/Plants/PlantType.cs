...
namespace Server.Engines.Plants
{
	...
	public class PlantTypeInfo
	{
		private static PlantTypeInfo[] m_Table = new PlantTypeInfo[]
			{ //           Plant Graphic, X, Y,     PlantType,                     Flower,Crossable,Seeds
				...
				new PlantTypeInfo( 0xC9E, -40, -30,	PlantType.CocoaTree,		    false, false, false ),
				new PlantTypeInfo( 0x4B8C, 5, 10,	PlantType.Vanilla,		       	false, true, false ),
				new PlantTypeInfo( 0x9A22, 0, 0,    PlantType.Coffee,				false, false, false ),
				new PlantTypeInfo( 0xA11D, 0, 0,    PlantType.Tea,                  true, false, false),
			};
		...
		public static PlantType RandomPeculiarGroupOne() //Currently only active/used one. Used in Foraging ATM
		{
			switch ( Utility.Random( 6 ) )
			{
				...
				case 4: return PlantType.HopsSouth;
		...
		public static PlantType RandomPeculiarGroupFour()
		{
			switch ( Utility.Random( 6 ) )
			{
				...
				case 2: return PlantType.CocoaTree;
                case 3: return PlantType.Vanilla;
				case 4: return PlantType.Tea;
				case 5: return PlantType.Coffee;

...
namespace Server.Engines.Plants
{
	...
	public class PlantItem : Item, ISecurable
	{
        ...
        public virtual bool RequiresUpkeep { get { return true; } } //Plant Upkeep - Default True - Required for Raised Garden Plant 
        public virtual bool MaginciaPlant { get { return false; } } //Magincia Garden - Currently not implemented
        public virtual int BowlOfDirtID { get { return 0x1602; } } 
        public virtual int GreenBowlID { get { return 0x1600; } } 

        public virtual int ContainerLocalization { get { return 1150435; } } //bowl
        public virtual int OnPlantLocalization { get { return 1061922; } } //You plant the seed in the bowl of dirt
        public virtual int CantUseLocalization { get { return 1061921; } } //The bowl of dirt must be in your pack, or you must lock it down
        #endregion
		...
		public bool ApplyPotion( PotionEffect effect, bool testOnly, out int message )
		{
			...
			if ( !RequiresUpkeep )
            {
                message = 1150619; // You don't need to pour potions on it.
                return false;
            }

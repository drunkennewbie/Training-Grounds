...
namespace Server.Items
{
	...
	#region Beverage Machine
	public class HotCocoaMug : PewterMug
	{
		[Constructable]
		public HotCocoaMug()
	...
	public class GreenTeaMug : PewterMug
	{
		[Constructable]
		public GreenTeaMug()
		...
		public override void AddNameProperty(ObjectPropertyList list)
		{
			...
			{
				list.Add(1049515, "#1030315"); // a mug of Green Tea
			}
			else
			{
				base.AddNameProperty(list);
		...
		public GreenTeaMug(Serial serial)
			: base(serial)
		{
		}
	...
	public class CoffeeMug : PewterMug
	{
		[Constructable]
		public CoffeeMug()
